...
// DEFINITION 
// 1- innerHTML
// Sert à : Lire ou modifier le HTML interne d’un élément.
// Permet d’ajouter des balises HTML (<b>, <p>, <img>, etc.).

// 2- textContent
// Sert à : Récupérer ou modifier uniquement le texte.
// Ignore complètement les balises HTML.

// 3- innerText
// Sert à : Lire ou modifier le texte visible à l’écran.
// Tient compte du CSS (éléments cachés, retours à la ligne, etc.).

// 4- htmlFor
// Sert à : Associer un élément <label> à un champ de formulaire.
// Correspond à l’attribut HTML "for".
// Très utilisé pour relier un label à un input.
