...
// Fonction permettant de simuler un appel asynchrone (API, Base de données, etc.)
const getData = () => {
      ...
      if (success) {
        resolve([
          ...
          },
          {
            name: "BPM",
            description:
              "Sauce barbecue, mozzarella, haché au bœuf, filet de poulet rôti et merguez",
            price: 2599,
            soldPrice: 1299,
            category: "pizza homme",
          ...
          },
          {
            ...
            description:
              "Sauce tomate à l'origan, mozzarella et saucisse pepperoni",
            price: 3599,
            soldPrice: 1399,
            category: "pizza homme",
          ...
          },
          {
            name: "Chèvre Miel",
            description:
              "Crème fraîche légère, mozzarella, fromage de chèvre, miel",
            price: 2999,
            soldPrice: 1199,
            category: "pizza homme",
          ...
          },
          {
            ...
            description:
              "Sauce barbecue, mozzarella, filet de poulet rôti, oignons rouges frais, champignons frais et poivrons verts frais",
            price: 2999,
            soldPrice: 1399,
            category: "pizza homme",
          ...
          },
          {
            name: "Nordique",
            description:
              "Crème fraîche légère, mozzarella et saumon fumé de Norvège",
            price: 3999,
            soldPrice: 1499,
            category: "pizza homme",
