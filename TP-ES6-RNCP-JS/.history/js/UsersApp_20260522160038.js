class Users {
    ...
    builTable() {
        ...
        const columns = [
            {label: 'Family Name', id: 'family'}, // id
            {label: 'Given Name', id: 'given'} // id
        ];
    ...
    buildRows() {
        ...
        this.listes.forEach(({familyName, givenName}) => {
            const row = this.table.insertRow();
            row.insertCell().textContent = familyName;
    ...
    sortBy(property) {
        ...
        // On reconstruit les lignes du tableau
        this.buildRows();
    }

    // Tri par nom de famille
    sortFamilyName() {
        this.sortBy('familyName');
    }

    // Tri par prenom
    sortGivenName(){
        this.sortBy('givenName');
    }
}